...
abstract public class Command extends CommandBase<Parameter> implements CommandExecutor, TabExecutor {
    ...
    @Override
    protected void setParameters(ParameterMap<Parameter> parameterMap) {
    ...
    public boolean onCommand(CommandSender sender, org.bukkit.command.Command command, String label, String[] args) {
        try {
            ...
            e.printStackTrace();
            sender.sendMessage("§cAn error occurred while trying to execute this command, please contact an administrator");
            return false;
        }
    }
